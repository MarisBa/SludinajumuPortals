            ...
            <form action="{{ route('ads.update', $ad->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Update Your Ad</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{$ad->name}}" placeholder="Enter a descriptive title">
                                <small class="form-text text-muted">Make it clear and descriptive to attract buyers</small>
                            </div>
                            
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea name="description" id="mytextarea" class="form-control" rows="5" placeholder="Provide detailed information about the item">{{$ad->description}}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="price" id="price" class="form-control" value="{{$ad->price}}" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="listing_location" id="listing_location" value="{{$ad->listing_location}}" placeholder="Enter specific location">
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="country_id" id="country_id"  value="{{$ad->country_id}}" required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="phone_number" id="phone_number" value="{{$ad->phone_number}}" placeholder="Enter phone number for buyers">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"  value="{{$ad->link}}" >Optional - include a video demonstration</small>
                            </div>
                        </div>
                        ...
                        <div class="form-section text-right">
                            ...
                            <button class="btn btn-primary px-4" type="submit">
                                <i class="fas fa-paper-plane mr-2"></i> Update ad
                            </button>
                        </div>
                    </div>
                </div>
